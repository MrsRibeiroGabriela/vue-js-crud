    ...
    <div class="row">
      <div class="col">
        <p class="h3 text-success fw-bold">Gerenciador de Contatos
          <router-link to="/contacts/add" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Novo</router-link>
        </p>
        <p class="fst-italic">Lorem ipsum, dolor sit amet consectetur adipisicing elit. A accusamus nemo cum vero distinctio? Corrupti nostrum veniam ipsam et, esse a tenetur sint, cumque unde perspiciatis deleniti ea, ratione officia!</p>
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col">
          ...
          <div class="card-body">
            <div class="row  align-items-center">
              ...
              <div class="col-sm-1 d-flex flex-column justify-content-center align-items-center">
                ...
                <button to="/" class="btn btn-danger my-1" @click="clickDeleteContact(contact.id)">
